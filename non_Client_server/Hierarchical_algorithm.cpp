...
{
    char s[500];
    ofstream f("C://Users//huawei//source//repos//Cluster Analysis//Cluster Analysis//Visualization//Algorithms//Hierarchicial algorithm//Hierarchial algorithm (graph).txt"), 
        g("C://Users//huawei//source//repos//Cluster Analysis//Cluster Analysis//Visualization//Algorithms//Hierarchicial algorithm//Hierarchial algorithm (graph).plt");

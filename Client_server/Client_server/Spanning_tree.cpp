...
{ 
    ofstream f("C://Users//huawei//source//repos//Cluster Analysis//Cluster Analysis//Visualization//Algorithms//Spanning tree//Spanning tree (graph).txt"), 
        g("C://Users//huawei//source//repos//Cluster Analysis//Cluster Analysis//Visualization//Algorithms//Spanning tree//Spanning tree (graph).plt");
    ...
    f.close();
    g.close();
    f.open("C://Users//huawei//source//repos//Cluster Analysis//Cluster Analysis//Visualization//Algorithms//Spanning tree//Spanning tree (histogram).txt");
    g.open("C://Users//huawei//source//repos//Cluster Analysis//Cluster Analysis//Visualization//Algorithms//Spanning tree//Spanning tree (histogram).plt");
